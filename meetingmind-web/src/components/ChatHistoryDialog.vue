<template>
    <el-dialog :title="'与' + agentName + '的聊天记录' + (currentMacAddress ? '[' + currentMacAddress + ']' : '')"
        ...
        <div class="chat-container">
            <div v-if="!isCollapsed" class="session-list" @scroll="handleScroll">
                <!-- 收起会话列表 -->
                <div v-if="!isCollapsed" class="collapse-btn-fold" @click="collapseSessions">
            ...
            <div class="chat-content">
                <!-- 展开会话列表 -->
                <div v-if="isCollapsed" class="collapse-btn-unfold" @click="collapseSessions">
