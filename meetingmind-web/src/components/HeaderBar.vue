  ...
  <el-header class="header">
    <div class="header-container">
      ...
      <div class="header-left" @click="goHome">
        <img loading="lazy" alt="" src="@/assets/logo.png" class="logo-img" />
        <!-- <img loading="lazy" alt="" src="@/assets/xiaozhi-ai.png" class="brand-img" /> -->
      </div>

      <!-- 中间导航菜单 -->
      <div v-if="isSuperAdmin" class="header-center">
        ...
        <div class="equipment-management" :class="{ 'active-tab': $route.path === '/model-config' }"
          @click="goModelConfig">
        ...
        <el-dropdown trigger="click" class="equipment-management more-dropdown"
    ...
    <div v-if="!isHome && !isSuperAdmin" class="go-back-btn" @click="goBack">
