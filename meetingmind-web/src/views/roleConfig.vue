      ...
      <div class="content-panel">
        <div class="content-area">
          <el-card class="config-card" shadow="never">
            ...
            <el-form ref="form" :model="form" label-width="72px" label-position="top">
...
export default {
  ...
  methods: {
    ...
    saveConfig() {
      ...
      Api.agent.updateAgentConfig(this.$route.query.agentId || this.agentId, configData, ({ data }) => {
        if (data.code === 0) {
  ...
  mounted() {
    const agentId = this.$route.query.agentId || this.agentId;
    if (agentId) {
